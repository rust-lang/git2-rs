...
extern {
    ...
    pub fn git_rebase_init(out: *mut *mut git_rebase,
                           ...
                           opts: *const git_rebase_options) -> c_int;
    pub fn git_rebase_open(out: *mut *mut git_rebase, repo: *mut git_repository, opts: *const git_rebase_options) -> c_int;
    ...
    pub fn git_rebase_operation_byindex(rebase: *mut git_rebase, idx: size_t) -> *mut git_rebase_operation;
    pub fn git_rebase_next(operation: *mut *mut git_rebase_operation, rebase: *mut git_rebase) -> c_int;
